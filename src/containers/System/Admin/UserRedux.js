...
class UserRedux extends Component {
    ...
    handleOnchangeImage = async (event) => {
        ...
        if (file) {
            ...
            let objectUrl = URL.createObjectURL(file); //api của html nó tạo ngay 1 đường link url xem đc ảnh
            this.setState({
    ...
    render() {
        ...
        return (
            <div className="user-redux-container">
                <div className='title'>
                    User Redux hoangphuc
                </div>
                <div>{isGetGenders === true ? 'Loading genders' : ''}</div>
                <div className='user-redux-body'>
                    <div className='container'>
                        <div className='rol-12 my-3'><FormattedMessage id="manage-user.add" /></div>
                        ...
                        <div className='row'>
                            <div className='col-3'>
                                ...
                                <input
                                    ...
                                    type='email'
                                    value={email}  // Ensure email is not null
